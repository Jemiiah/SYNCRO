...
export function useBulkActions({
    ...
    }, [selectedSubscriptions, subscriptions, updateSubscriptions, addToHistory, setSelectedSubscriptions, setBulkActionLoading, onToast, onShowDialog]);
            ...
            onConfirm: async () => {
                ...
                try {
                    ...
                    for (const id of selectedIds) {
                        ...
                        if (sub) {
                            const daysUntilRenewal = (sub as any).renewsIn || (sub as any).renews_in || 0;
